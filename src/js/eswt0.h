prog_char eswt0_string_0[] PROGMEM =
	"VM: warning: using undefined global `%s'%s";
prog_char eswt0_string_1[] PROGMEM = "illegal builtin object for load_property";
prog_char eswt0_string_2[] PROGMEM = "illegal object for load_property";
prog_char eswt0_string_3[] PROGMEM = "illegal value for set_property";
prog_char eswt0_string_4[] PROGMEM =
	"illegal builtin object for store_property";
prog_char eswt0_string_5[] PROGMEM = "illegal value for set_property";
prog_char eswt0_string_6[] PROGMEM = "illegal object for set_property";
prog_char eswt0_string_7[] PROGMEM = "illegal object for set_property";
prog_char eswt0_string_8[] PROGMEM = "illegal object for store_property";
prog_char eswt0_string_9[] PROGMEM =
	"integer indexes not implemented yet for BUILTIN in load_array";
prog_char eswt0_string_10[] PROGMEM = "illegal builtin object for load_array";
prog_char eswt0_string_11[] PROGMEM = "string index out of range in load_array";
prog_char eswt0_string_12[] PROGMEM = "illegal string index in load_array";
prog_char eswt0_string_13[] PROGMEM = "illegal object for load_array";
prog_char eswt0_string_14[] PROGMEM =
	"integer index not implemented yet for BUILTIN in store_array";
prog_char eswt0_string_15[] PROGMEM = "illegal value for prototype";
prog_char eswt0_string_16[] PROGMEM = "illegal builtin object for store_array";
prog_char eswt0_string_17[] PROGMEM = "illegal array index in store_array";
prog_char eswt0_string_18[] PROGMEM = "negative array index in store_array";
prog_char eswt0_string_19[] PROGMEM = "illegal array index in store_array";
prog_char eswt0_string_20[] PROGMEM = "static string in store_array";
prog_char eswt0_string_21[] PROGMEM = "negative string index in store_array";
prog_char eswt0_string_22[] PROGMEM =
	"non-integer value to store into string in store_array";
prog_char eswt0_string_23[] PROGMEM = "illegal string index in store_array";
prog_char eswt0_string_24[] PROGMEM = "illegal object for store_array";
prog_char eswt0_string_25[] PROGMEM = "illegal object for nth";
prog_char eswt0_string_26[] PROGMEM = "call_method: unknown method";
prog_char eswt0_string_27[] PROGMEM = "illegal builtin object for call_method";
prog_char eswt0_string_28[] PROGMEM = "call_method: unknown method";
prog_char eswt0_string_29[] PROGMEM = "call_method: unknown method";
prog_char eswt0_string_30[] PROGMEM = "illegal object for call_method";
prog_char eswt0_string_31[] PROGMEM = "illegal object for new";
prog_char eswt0_string_32[] PROGMEM =
	"delete_property: JS_BUILTIN: not implemented yet";
prog_char eswt0_string_33[] PROGMEM =
	"delete_property: not implemented yet for the with-chain objects";
prog_char eswt0_string_34[] PROGMEM = "illegal object for delete_property";
prog_char eswt0_string_35[] PROGMEM =
	"delete_array: JS_BUILTIN: not implemented yet";
prog_char eswt0_string_36[] PROGMEM = "illegal array index in delete_array";
prog_char eswt0_string_37[] PROGMEM = "illegal object for delete_array";
prog_char eswt0_string_38[] PROGMEM = "stack overflow";
prog_char eswt0_string_39[] PROGMEM = "illegal object for with_push";
prog_char eswt0_string_40[] PROGMEM = "with stack underflow in with_pop";
prog_char eswt0_string_41[] PROGMEM = "corrupted with-chain in load_global";
prog_char eswt0_string_42[] PROGMEM = "corrupted with-chain in jsr_w";
...
case 19:
  ...
  if (vm->warn_undef && JS_SP1->type == JS_UNDEFINED)
    {
      sprintf_P (buf, eswt0_string_0, js_vm_symname (vm, j),
		 JS_HOST_LINE_BREAK);
      //js_iostream_write (vm->s_stderr, buf, strlen (buf));
    }
  break;
...
case 27:
  if (JS_SP2->type == JS_BUILTIN)
	...
	ERROR (eswt0_string_12);
    }
  else
    ERROR (eswt0_string_13);
  break;
  ...
  if (JS_SP2->type == JS_BUILTIN)
      ...
      else if (JS_SP1->type == JS_STRING)
	{
	  ...
	  if (JS_SP2->u.vbuiltin->info->property_proc)
	    ...
	    ERROR (eswt0_string_16);

	  JS_POP_N (3);
	}
      else
	ERROR (eswt0_string_17);
    }
  else if (JS_SP2->type == JS_OBJECT)
    {
      ...
      if (JS_SP1->type == JS_INTEGER)
	{
	  if (JS_SP2->u.vstring->staticp)
	    ERROR (eswt0_string_20);

	  if (JS_SP1->u.vinteger < 0)
	    ERROR (eswt0_string_21);

	  if (JS_SP (3)->type != JS_INTEGER)
	    ERROR (eswt0_string_22);
	...
	ERROR (eswt0_string_23);
    }
  else
    ERROR (eswt0_string_24);
  ...
  if (JS_SP1->type == JS_BUILTIN)
      ...
      if (JS_SP1->u.vbuiltin->info->method_proc)
	{
	  if ((*JS_SP1->u.vbuiltin->info->method_proc) (
	      ...
	      == JS_PROPERTY_UNKNOWN)
	    ERROR (eswt0_string_26);
	}
      else
	ERROR (eswt0_string_27);
...
case 60:
  if (JS_SP2->type == JS_BUILTIN)
	...
	ERROR (eswt0_string_36);
    }
  else
    ERROR (eswt0_string_37);
