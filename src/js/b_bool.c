...
prog_char b_bool_string_0[] PROGMEM = "Boolean(): illegal amount of arguments";
prog_char b_bool_string_1[] PROGMEM =
        "Boolean.%s(): illegal amount of arguments";
prog_char b_bool_string_2[] PROGMEM =
        "new Boolean(): illegal amount of arguments";
	       ...
	       JSNode *args)
{
  ...
  if (args->u.vinteger == 0)
    ...
    {
      sprintf_P (vm->error, b_bool_string_0);
      js_vm_error (vm);
    }
}
  ...
  if (method == vm->syms.s_toString)
    {
      if (args->u.vinteger != 0)
	{
	  sprintf_P (vm->error, b_bool_string_1, js_vm_symname (vm, method));
	  js_vm_error (vm);
	}
	  ...
	  JSNode *result_return)
{
  ...
  if (args->u.vinteger == 0)
    ...
    {
      sprintf_P (vm->error, b_bool_string_2);
      js_vm_error (vm);
    }
