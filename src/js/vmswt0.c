...
prog_char vmswt0_string_0[] PROGMEM = "VM: link: %s(): start=%d, length=%d";
prog_char vmswt0_string_1[] PROGMEM = ", relocating with offset %u";
prog_char vmswt0_string_2[] PROGMEM = "illegal function in apply";
prog_char vmswt0_string_3[] PROGMEM = "VM: calling function%s";
prog_char vmswt0_string_4[] PROGMEM = "VM: exec: %s%s";
prog_char vmswt0_string_5[] PROGMEM = "execute_code: unknown opcode %d%s";
