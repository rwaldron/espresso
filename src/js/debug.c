...
prog_char debug_string_0[] PROGMEM = "VM: stacktrace: stacksize=%d, used=%d%s";
prog_char debug_string_1[] PROGMEM = " ra=0x%lx, wp=0x%lx, af=%d:%d, ofp=0x%lx";
...
js_vm_stacktrace (JSVirtualMachine *vm, unsigned int num_frames)
{
  ...
  sprintf_P (buf, debug_string_0, vm->stack_size,
             (vm->stack + vm->stack_size - sp), JS_HOST_LINE_BREAK);
