...
prog_char b_object_string_0[] PROGMEM = "Object(): illegal amount of arguments";
prog_char b_object_string_1[] PROGMEM =
        "new Object(): illegal amount of arguments";
	       ...
	       JSNode *args)
{
  if (args->u.vinteger > 1)
    {
      sprintf_P (vm->error, b_object_string_0);
      js_vm_error (vm);
    }
	  ...
	  JSNode *result_return)
{
  if (args->u.vinteger == 0)
    ...
    {
      sprintf_P (vm->error, b_object_string_1);
      js_vm_error (vm);
    }
}
