...
prog_char b_math_string_0[] PROGMEM = "Math.%s(): illegal amount of arguments";
prog_char b_math_string_1[] PROGMEM = "Math.%s(): illegal argument";
prog_char b_math_string_2[] PROGMEM = "Math.%s: immutable property";
	...
	JSNode *args)
{
 ...
 argument_error:
  sprintf_P (vm->error, b_math_string_0, js_vm_symname (vm, method));
  js_vm_error (vm);

 argument_type_error:
  sprintf_P (vm->error, b_math_string_1, js_vm_symname (vm, method));
  js_vm_error (vm);
	  ...
	  void *instance_context, JSSymbol property, int set, JSNode *node)
{
 ...
 immutable:
  sprintf_P (vm->error, b_math_string_2, js_vm_symname (vm, property));
  js_vm_error (vm);
