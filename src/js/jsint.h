...
#define JS_NULL		1
#define JS_BOOLEAN 	2
#define JS_INTEGER 	3		/* Integer, float and nan are `number' */
#define JS_STRING 	4
#define JS_FLOAT 	5
#define JS_ARRAY	6
#define JS_OBJECT	7
...
#define JS_SYMBOL 	10
#define JS_BUILTIN 	11
#define JS_FUNC		12
#define JS_NAN		13

#define JS_IPTR 	14
#define JS_ARGS_FIX	15

typedef unsigned char JSNodeType;
...
extern prog_uchar js_latin1_tolower [256] PROGMEM;
extern prog_uchar js_latin1_toupper[256] PROGMEM;
